...
import { createBlog, deleteBlog } from '../../../redux/slices/product';
// utils
...
export default function BlogEditPostForm({ isEdit, currentProduct, blogId }) {
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4}>
              ...
              <Stack direction="row" justifyContent="flex-end" sx={{ mt: 3 }}>
                ...
                <LoadingButton color='error' fullWidth type="submit" variant="contained" size="large" loading={isSubmitting}>
                  Delete
                </LoadingButton>
              </Stack>
            </Grid>
