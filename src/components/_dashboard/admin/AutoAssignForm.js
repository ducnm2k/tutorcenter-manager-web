...
import { createOrder, putAutoAssign, updateStatusParentsClass } from '../../../redux/slices/product';
// utils
...
export default function AutoAssignForm({ isEdit, currentProduct }) {
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4}>
            <Stack spacing={3}>
              ...
              <LoadingButton type="submit" fullWidth variant="contained" size="large" loading={isSubmitting} onClick={handleAutoAssign}>
                {!isEdit ? 'Auto Assign' : 'Auto Assign'}
              </LoadingButton>
            </Stack>
          </Grid>
        </Grid>
