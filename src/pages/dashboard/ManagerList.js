...
import { getUserList, deleteUser, getParentsList, getManagerList } from '../../redux/slices/user';
// routes
              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { userId, fullname, email, phone, status} = row;
                    ...
                    return (
                      <TableRow
                        ...
                        component={RouterLink}
                        to={`${PATH_DASHBOARD.managerAccount.root}/edit/${userId}`}
